...
int main(int argc, char* argv[])
{
  ...
  12:	83 ec 04             	sub    $0x4,%esp
    ...
    {
        int id = fork();
  15:	e8 81 02 00 00       	call   29b <fork>
        if(id == 0)
  1a:	85 c0                	test   %eax,%eax
  1c:	75 12                	jne    30 <main+0x30>
        {
            arr = malloc(size*1000 * sizeof(int));
  1e:	83 ec 0c             	sub    $0xc,%esp
  21:	68 a0 0f 00 00       	push   $0xfa0
  26:	e8 35 06 00 00       	call   660 <malloc>
  2b:	83 c4 10             	add    $0x10,%esp
            while(true)
  2e:	eb fe                	jmp    2e <main+0x2e>
                continue;
            }
            *arr = 2;
        }
    ...
    proc_dump();
  30:	e8 0e 03 00 00       	call   343 <proc_dump>
    exit();
